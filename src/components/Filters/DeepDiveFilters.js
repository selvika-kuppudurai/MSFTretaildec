...
const DeepDiveFilters = ({ sendData, dispatch }) => {
    ...
    useEffect(() => {
        if (sessionStorage.getItem("deepdiveFilter")) {
            ...
            let filterSessionData = JSON.parse(sessionStorage.getItem("deepdiveFilter"))
    ...
    const handleChange = (data, name) => {
        ...
        sessionStorage.setItem("deepdiveFilter", JSON.stringify(chosenFilters))
        ...
        <div className="filter d-flex mt-4 pt-4 col-12">
            ...
            <div className="filter__width">
                <div className='dropdowndesign'>
                    ...
                    <NormalSelect options={Object.keys(summaryDataforwholefilter).length > 0 ? summaryDataforwholefilter.model : summaryDataforwholefilter.model} handleChange={(data) => handleChange(data, "Model")} values={formFields.Model} />
                </div>
            </div>
            ...
            <div className="filter__width">
                ...
                <div className='dropdowndesign'>
                    ...
                    <NormalSelect options={Object.keys(getsummarydataforcountry).length > 0 ? getsummarydataforcountry : Object.keys(summaryDataforwholefilter).length > 0 ? summaryDataforwholefilter.country : summaryDataforwholefilter.country} val='country' handleChange={(data) => handleChange(data, "Country")} values={formFields.Country} />
                </div>
            </div>
