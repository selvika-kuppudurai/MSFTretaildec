...
export default class SimpleReactValidator {
  ...
  constructor(options = {}) {
    ...
    this.rules = {
      accepted: {
        message: "Your :attribute must be accepted.",
        rule: (val) => val === true,
        required: true,
      },
      after: {
      ...
      alpha_num_space: {
        message:
          "Your :attribute may only contain letters, numbers, and spaces.",
        rule: (val) => this.helpers.testRegex(val, /^[A-Z0-9\s]*$/i),
      },
      alpha_num_dash: {
        message:
          "Your :attribute may only contain letters, numbers, and dashes.",
        rule: (val) => this.helpers.testRegex(val, /^[A-Z0-9-]*$/i),
      },
      num_dash: {
      ...
      alpha_num_dash_space: {
        message:
          "Your :attribute may only contain letters, numbers, dashes, and spaces.",
        rule: (val) => this.helpers.testRegex(val, /^[A-Z0-9-\s]*$/i),
      },
      array: {
        message: "Your :attribute must be an array.",
      ...
      boolean: {
        message: "Your :attribute must be a boolean.",
      ...
      integer: {
        message: "Your :attribute must be an integer.",
      ...
      string: {
        message: "Your :attribute must be a string.",
  ...
  helpers = {
    ...
    getOptions(validation) {
      if (
        ...
        var param = validation.split(":");
        return param.length > 1 ? param[1].split(",") : [];
      }
    },
